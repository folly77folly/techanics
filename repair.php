        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            ...
            <div class="email">
                ...
                <h3 style="border-bottom: 2px #3d2f95 solid; padding-bottom: 10px;"><b><br>Book A Repair</b></h3><br>
                <i class="icofont-download"></i>
                <p >Download the app to get repair service <b>at your Doorstep</b>.</p>
                <div class="asimg row mt-2 mb-2">
                      <div class='col-6 text-center'>
                          <a href="https://play.google.com/store/apps/details?id=com.hspmdeveloper.bsauto" target="__blank"><img src='assets/img/playstoreicon.jpg'></a>
                      </div>
                      <div class='col-6 text-center'>
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
                <div class="form-group col-md-12">
                    <h4 style="border-bottom: 2px #3d2f95 solid; width: 20%; padding-bottom: 10px;"><b>Enquiry</b></h4>
                </div>
